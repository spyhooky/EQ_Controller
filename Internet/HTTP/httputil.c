...
static void make_basic_config_setting_json_callback(char* buf)
{
  sprintf(buf,"settingsCallback({\
                ...
                USARTCAN.Usart[RS485_1][EnUart],USARTCAN.Usart[RS485_1][uartBaudrate],USARTCAN.Usart[RS485_1][Databits],USARTCAN.Usart[RS485_1][Chkbits],USARTCAN.Usart[RS485_1][Stopbits],USARTCAN.Usart[RS485_1][uartDatatype],
                USARTCAN.Usart[RS485_2][EnUart],USARTCAN.Usart[RS485_2][uartBaudrate],USARTCAN.Usart[RS485_2][Databits],USARTCAN.Usart[RS485_2][Chkbits],USARTCAN.Usart[RS485_2][Stopbits],USARTCAN.Usart[RS485_2][uartDatatype],
				USARTCAN.Usart[RS485_3][EnUart],USARTCAN.Usart[RS485_3][uartBaudrate],USARTCAN.Usart[RS485_3][Databits],USARTCAN.Usart[RS485_3][Chkbits],USARTCAN.Usart[RS485_3][Stopbits],USARTCAN.Usart[RS485_3][uartDatatype],
                USARTCAN.Usart[RS485_4][EnUart],USARTCAN.Usart[RS485_4][uartBaudrate],USARTCAN.Usart[RS485_4][Databits],USARTCAN.Usart[RS485_4][Chkbits],USARTCAN.Usart[RS485_4][Stopbits],USARTCAN.Usart[RS485_4][uartDatatype],
                USARTCAN.tout
                );
}
...
void cgi_ipconfig(st_http_request *http_request)
{
    ...
    {
        USARTCAN.Usart[RS485_1][EnUart] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"baud2")))
    {
        USARTCAN.Usart[RS485_1][uartBaudrate] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"databit2")))
    {
        USARTCAN.Usart[RS485_1][Databits] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"parity2")))
    {
        USARTCAN.Usart[RS485_1][Chkbits] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"stopbit2")))
    {
        USARTCAN.Usart[RS485_1][Stopbits] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"datatype2")))
    {
        USARTCAN.Usart[RS485_1][uartDatatype] = AscToHex(*param);		
    }
    
    //====================================.Usart[RS485_2]
    if((param = get_http_param_value(http_request->URI,"use3")))
    {
        USARTCAN.Usart[RS485_2][EnUart] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"baud3")))
    {
        USARTCAN.Usart[RS485_2][uartBaudrate] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"databit3")))
    {
        USARTCAN.Usart[RS485_2][Databits] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"parity3")))
    {
        USARTCAN.Usart[RS485_2][Chkbits] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"stopbit3")))
    {
        USARTCAN.Usart[RS485_2][Stopbits] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"datatype3")))
    {
        USARTCAN.Usart[RS485_2][uartDatatype] = AscToHex(*param);		
    }
	
	//====================================.Usart[RS485_3]
    if((param = get_http_param_value(http_request->URI,"use3")))
    {
        USARTCAN.Usart[RS485_3][EnUart] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"baud3")))
    {
        USARTCAN.Usart[RS485_3][uartBaudrate] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"databit3")))
    {
        USARTCAN.Usart[RS485_3][Databits] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"parity3")))
    {
        USARTCAN.Usart[RS485_3][Chkbits] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"stopbit3")))
    {
        USARTCAN.Usart[RS485_3][Stopbits] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"datatype3")))
    {
        USARTCAN.Usart[RS485_3][uartDatatype] = AscToHex(*param);		
    }
    
    //====================================.Usart[RS485_4]
    if((param = get_http_param_value(http_request->URI,"use4")))
    {
        USARTCAN.Usart[RS485_4][EnUart] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"baud4")))
    {
        USARTCAN.Usart[RS485_4][uartBaudrate] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"databit4")))
    {
        USARTCAN.Usart[RS485_4][Databits] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"parity4")))
    {
        USARTCAN.Usart[RS485_4][Chkbits] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"stopbit4")))
    {
        USARTCAN.Usart[RS485_4][Stopbits] = AscToHex(*param);		
    }
    if((param = get_http_param_value(http_request->URI,"datatype4")))
    {
        USARTCAN.Usart[RS485_4][uartDatatype] = AscToHex(*param);		
    }
