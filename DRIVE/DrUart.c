...
/*********USART1************/
void DMA1_Channel4_HW_Start(u8 *_buf, u16 _len)
{
    DMA1_Channel4->CMAR = (u32)_buf;
    DMA1_Channel4->CNDTR = _len;
...
void DrUSART1_Init(void)
{
    ...
    GPIO_InitStructure.GPIO_Pin = USART1_TX_PIN;//USART1_TX ->PA2           
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP; 
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz; 
    GPIO_Init(USART1_PORT, &GPIO_InitStructure);  	   

    GPIO_InitStructure.GPIO_Pin = USART1_RX_PIN;//USART1_RX ->PA3           
    ...
    NVIC_InitStructure.NVIC_IRQChannelPreemptionPriority = USART1_PRE;
...
void DrUSART2_Init(void)
{
    ...
    RCC_APB2PeriphClockCmd(USART2_GPIO_APB,ENABLE); 
    NVIC_InitTypeDef NVIC_InitStructure;

    GPIO_InitStructure.GPIO_Pin = USART2_TX_PIN;//USART2_TX ->PA2        
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP; 
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz; 
    GPIO_Init(USART2_PORT, &GPIO_InitStructure);  	   

    GPIO_InitStructure.GPIO_Pin = USART2_RX_PIN;//USART2_RX ->PA3        
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;  //GPIO_Mode_AF_PP  GPIO_Mode_IN_FLOATING
    GPIO_Init(USART2_PORT, &GPIO_InitStructure);
	...
	GPIO_InitStructure.GPIO_Pin = USART2_EN_PIN;
...
void DrUSART3_Init(void)
{
    ...
    RCC_APB2PeriphClockCmd(USART3_GPIO_APB,ENABLE); 
    NVIC_InitTypeDef NVIC_InitStructure;

    GPIO_InitStructure.GPIO_Pin = USART3_TX_PIN;//USART3_TX ->PB10	         
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP; 
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz; 
    GPIO_Init(USART3_PORT, &GPIO_InitStructure);		   

    GPIO_InitStructure.GPIO_Pin = USART3_RX_PIN;//USART2_RX ->PB11	        
	...
	GPIO_InitStructure.GPIO_Pin = USART3_EN_PIN;//GPIOD->4，RS485方向控制
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_10MHz;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
...
void DrUART4_Init(void)
{
    ...
    if((USARTCAN.Usart[RS485_3][Databits]==1)&&(USARTCAN.Usart[RS485_3][Chkbits]!=0))//7 odd/even
    {
        databits=0;
    }
    else if((USARTCAN.Usart[RS485_3][Databits]==0)&&(USARTCAN.Usart[RS485_3][Chkbits]==0))//8 none
    {
        databits=0;
    }
    else if((USARTCAN.Usart[RS485_3][Databits]==0)&&(USARTCAN.Usart[RS485_3][Chkbits]!=0))//8 odd/even
    {
        databits=1;
    }
    else
    {
        USARTCAN.Usart[RS485_3][Databits]=0;
        USARTCAN.Usart[RS485_3][Chkbits]=0;
    }

    USART_InitStructure.USART_BaudRate = RS232_baud[USARTCAN.Usart[RS485_3][uartBaudrate]];
    USART_InitStructure.USART_WordLength = RS232_lenth[databits];//8位数据
    USART_InitStructure.USART_StopBits = RS232_stop[USARTCAN.Usart[RS485_3][Stopbits]];//1位停止位
    USART_InitStructure.USART_Parity = RS232_parity[USARTCAN.Usart[RS485_3][Chkbits]];//无奇偶校验
    USART_InitStructure.USART_Mode = USART_Mode_Rx | USART_Mode_Tx; //发送和接受使能
...
/****************************以下为UART5配置**************************/
	...
	if((USARTCAN.Usart[RS485_4][Databits]==1)&&(USARTCAN.Usart[RS485_4][Chkbits]!=0))//7 odd/even
    {
        databits=0;
    }
    else if((USARTCAN.Usart[RS485_4][Databits]==0)&&(USARTCAN.Usart[RS485_4][Chkbits]==0))//8 none
    {
        databits=0;
    }
    else if((USARTCAN.Usart[RS485_4][Databits]==0)&&(USARTCAN.Usart[RS485_4][Chkbits]!=0))//8 odd/even
    {
        databits=1;
    }
    else
    {
        USARTCAN.Usart[RS485_4][Databits]=0;
        USARTCAN.Usart[RS485_4][Chkbits]=0;
    }

    USART_InitStructure.USART_BaudRate = RS232_baud[USARTCAN.Usart[RS485_4][uartBaudrate]];
    USART_InitStructure.USART_WordLength = RS232_lenth[databits];//8位数据
    USART_InitStructure.USART_StopBits = RS232_stop[USARTCAN.Usart[RS485_4][Stopbits]];//1位停止位
    USART_InitStructure.USART_Parity = RS232_parity[USARTCAN.Usart[RS485_4][Chkbits]];//无奇偶校验
    USART_InitStructure.USART_Mode = USART_Mode_Rx | USART_Mode_Tx; //发送和接受使能
	...
	GPIO_InitStructure.GPIO_Pin = UART5_EN_PIN;//GPIOD->4，RS485方向控制
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_10MHz;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
	GPIO_Init(UART5_EN_PORT, &GPIO_InitStructure);
...
void DrUsart_Init(void)
{
    ...
    if(USARTCAN.Usart[RS485_3][EnUart]==ON)
    {
        DrUART4_Init();
    }
	if(USARTCAN.Usart[RS485_4][EnUart]==ON)
    {
        DrUART5_Init();
    }
}
