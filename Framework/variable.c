...
Interface_Info USARTCAN = { 
                            ...
                            .Usart[RS485_1] = {1,3, 0, 0, 0, 0, 0,10},
							.Usart[RS485_2] = {1,8, 0, 0, 1, 0, 0,10},
...
u16 cpu_sr;                        //cpu中断状态
OS_EVENT *mBOX_Uart_Recv[NUM_UARTCHANNEL];    //所有串口收到消息后需要发送队列给其他task处理
...
{
    return Global_Driver.AD_Result[chanel];
}
